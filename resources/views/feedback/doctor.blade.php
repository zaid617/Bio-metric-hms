...
@section('title', 'Doctor Feedback & Treatment Sessions')
...
<div class="container">
    ...
    <form method="POST" action="{{ url('/feedback/doctor-submit') }}">
        @csrf
        ...
        <div class="mb-3">
            <label>Remarks:</label>
            <textarea name="doctor_remarks" rows="4" class="form-control" required>{{ old('doctor_remarks') }}</textarea>
        </div>
