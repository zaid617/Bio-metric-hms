...
class PayrollService
{
    ...
    public function calculateAndPersistPayroll(Employee $employee, Carbon $periodStart, Carbon $periodEnd, ?User $generatedBy = null, ?AttendancePayroll $payroll = null): AttendancePayroll
    {
        ...
        $payroll->fill([
            ...
            'total_late_count' => $result['total_late_count'] ?? $result['late_days'],
            'total_late_minutes' => $result['total_late_minutes'] ?? 0,
            'total_working_hours' => $result['total_working_hours'],
            'overtime_hours' => $result['overtime_hours'],
            'total_overtime_hours' => $result['total_overtime_hours'] ?? $result['overtime_hours'],
            ...
            'tax' => $result['tax'] ?? 0,
            'provident_fund' => $result['provident_fund'] ?? 0,
            'eobi' => $result['eobi'] ?? 0,
